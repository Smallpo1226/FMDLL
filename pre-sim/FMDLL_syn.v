...
module Clock_divider ( M, rst_n, DIV_M, clk_ext, clk2, clk4 );
  ...
  INVX2 U3 ( .A(N17), .Y(n5) );
  INVX2 U4 ( .A(N19), .Y(n6) );
  AND2X2 U5 ( .A(cnt_2[0]), .B(N15), .Y(N19) );
  AND2X2 U6 ( .A(cnt_4[0]), .B(N12), .Y(N17) );
  NAND2BX2 U7 ( .AN(cnt_2[1]), .B(cnt_2[0]), .Y(N15) );
  NAND2BX2 U8 ( .AN(cnt_4[0]), .B(cnt_4[1]), .Y(N12) );
  XNOR2X1 U9 ( .A(n3), .B(N19), .Y(cnt_tmp_2_1_) );
  NAND2X2 U10 ( .A(N15), .B(cnt_2[1]), .Y(n3) );
  XNOR2X1 U11 ( .A(n4), .B(N17), .Y(cnt_tmp_4_1_) );
  NAND2X2 U12 ( .A(N12), .B(cnt_4[1]), .Y(n4) );
...
module PTC ( M, M_counter, DIV_M, clk_ext, N, N_counter, rst_n, Q, Q_next, T, 
  ...
  Clock_divider P0 ( .M(M), .rst_n(n1), .DIV_M(DIV_M), .clk_ext(clk_ext), 
        .clk2(clk2), .clk4(clk4) );
...
module FD_N ( N, clk_out, rst_n, N_counter, DIV_N );
  ...
  DFFRQX2 DIV_N_reg ( .D(n9), .CK(clk_out), .RN(rst_n), .Q(DIV_N) );
...
module Select_Logic ( DIV_N, clk_out, DIV_M, M, M_counter, Sel, rst_n );
  ...
  wire   n23, N19, N21, n3, n4, n5, n6, n9, n10, n11, n12, n13, n1, n7, n8,
         n14, n15, n16, n17, n18, n190, n20, n210, n22;

  NAND3X8 U12 ( .A(rst_n), .B(n23), .C(n13), .Y(N19) );
  AOI211X4 U13 ( .A0(n5), .A1(n22), .B0(n1), .C0(n4), .Y(n13) );
  TLATX4 Sel_tmp_reg_0_ ( .G(N19), .D(n190), .Q(Sel[0]), .QN(n15) );
  TLATX1 Sel_tmp_reg_1_ ( .G(N19), .D(N21), .Q(n23), .QN(n7) );
  AOI32XL U4 ( .A0(n4), .A1(n210), .A2(n23), .B0(n5), .B1(n6), .Y(n3) );
  AOI2B1X2 U8 ( .A1N(n20), .A0(n5), .B0(n4), .Y(n10) );
  OAI21XL U7 ( .A0(n4), .A1(n22), .B0(n12), .Y(n11) );
  NOR3X4 U10 ( .A(clk_out), .B(DIV_N), .C(DIV_M), .Y(n12) );
  NAND2BX2 U11 ( .AN(DIV_N), .B(DIV_M), .Y(n9) );
  INVXL U3 ( .A(n15), .Y(n1) );
  INVX3 U5 ( .A(n7), .Y(Sel[1]) );
  AOI22X4 U6 ( .A0(n10), .A1(n16), .B0(n16), .B1(n15), .Y(n190) );
  INVX2 U9 ( .A(n12), .Y(n210) );
  INVX2 U14 ( .A(n14), .Y(n16) );
  NAND2BX1 U15 ( .AN(n8), .B(n11), .Y(n14) );
  NAND2BX2 U16 ( .AN(n18), .B(n210), .Y(n20) );
  INVX2 U17 ( .A(rst_n), .Y(n8) );
  NAND2BX2 U18 ( .AN(n17), .B(n9), .Y(n18) );
  NOR2X2 U19 ( .A(n5), .B(DIV_M), .Y(n4) );
  INVX2 U20 ( .A(n22), .Y(n17) );
  NOR2X2 U21 ( .A(n3), .B(n8), .Y(N21) );
  OAI32XL U22 ( .A0(n12), .A1(n18), .A2(n7), .B0(n9), .B1(n17), .Y(n6) );
  NAND2BX2 U23 ( .AN(M_counter[1]), .B(M_counter[0]), .Y(n22) );
  NAND2BX2 U24 ( .AN(M[1]), .B(M[0]), .Y(n5) );
endmodule
...
module FMC ( clk_ext, clk_out, rst_n, M_counter, N_counter, M, N, Sel, DIV_M, 
  ...
  output DIV_M, DIV_N;
  wire   n8, DIV_M_tmp, n3, n4, n1, n5, n6, n7;

  FD_M F0 ( .M(M), .clk_ext(clk_ext), .M_counter(M_counter), .DIV_M(DIV_M_tmp)
         );
  FD_N F1 ( .N(N), .clk_out(clk_out), .rst_n(n5), .N_counter(N_counter), 
        .DIV_N(DIV_N) );
  Select_Logic F2 ( .DIV_N(DIV_N), .clk_out(clk_out), .DIV_M(DIV_M), .M(M), 
        .M_counter(M_counter), .Sel({Sel[1], n8}), .rst_n(n5) );
  INVX2 U2 ( .A(n6), .Y(n5) );
  INVX2 U3 ( .A(rst_n), .Y(n6) );
  INVX12 U4 ( .A(n1), .Y(Sel[0]) );
  INVX4 U5 ( .A(n8), .Y(n1) );
  INVX2 U6 ( .A(n3), .Y(DIV_M) );
  AOI32XL U7 ( .A0(clk_ext), .A1(n7), .A2(n5), .B0(DIV_M_tmp), .B1(n4), .Y(n3)
         );
  INVX2 U8 ( .A(n4), .Y(n7) );
  NAND2BX2 U9 ( .AN(M[1]), .B(M[0]), .Y(n4) );
endmodule
...
module DCDL ( clk_mid, T, Tb, T_f1, Tb_f1, T_f2, Tb_f2, Sel, clk_ext, 
  ...
  output clk_out;
  wire   clk_mid_tmp, clk_coarse_out, clk_fine_out, inv_in, n3, n1;

  NOR2X8 U4 ( .A(clk_out_out), .B(Sel[1]), .Y(n3) );
  ...
  AOI31X4 U2 ( .A0(clk_ext), .A1(Sel[0]), .A2(n3), .B0(n1), .Y(clk_mid_tmp) );
  INVX1 U3 ( .A(clk_mid), .Y(n1) );
  INVX2 U5 ( .A(inv_in), .Y(clk_out) );
endmodule
...
module FMDLL ( M, N, rst_n, clk_ext, clk_out, Sel );
  input [1:0] M;
  input [3:0] N;
  output [1:0] Sel;
  input rst_n, clk_ext;
  output clk_out;
  wire   DIV_M, DIV_N, Q_9_, Q_8_, Q_7_, Q_6_, Q_5_, Q_4_, Q_3_, Q_2_, Q_1_,
         Q_0_, clk_mid, n15, n17, n18, n19, n20, n21, n22, n23, n24, n25, n26,
         n27, n28, n29, n30, n31, n32, n33, n34, n35, n36, n37, n38, n39, n40,
         n41, n42, n43, n44, n45, n46, n47, n48, n49, n51, n52, n53;
  wire   [9:0] Q_next;
  wire   [15:0] T;
  wire   [15:0] Tb;
  wire   [7:0] T_f1;
  ...
  CLKBUFX2 glitch_eliminate_0__G0 ( .A(n53), .Y(glitch_free[1]) );
  ...
  CLKBUFX2 glitch_eliminate_34__G0 ( .A(glitch_free[34]), .Y(n51) );
  AOI31X4 U22 ( .A0(Sel[0]), .A1(n17), .A2(clk_ext), .B0(Sel[1]), .Y(n15) );
  NOR2X8 U25 ( .A(Sel[1]), .B(clk_out), .Y(n18) );
  PTC U0 ( .M({M[1], n19}), .M_counter(M_counter), .DIV_M(DIV_M), .clk_ext(
        clk_ext), .N(N), .N_counter(N_counter), .rst_n(n20), .Q({Q_9_, Q_8_, 
        Q_7_, Q_6_, Q_5_, Q_4_, Q_3_, Q_2_, Q_1_, Q_0_}), .Q_next(Q_next), .T(
        T), .Tb(Tb), .T_f1(T_f1), .Tb_f1(Tb_f1), .T_f2(T_f2), .Tb_f2(Tb_f2), 
        .Sel_0_(Sel[0]) );
  FMC U1 ( .clk_ext(clk_ext), .clk_out(n49), .rst_n(n20), .M_counter(M_counter), .N_counter(N_counter), .M({M[1], n19}), .N(N), .Sel(Sel), .DIV_M(DIV_M), 
        .DIV_N(DIV_N) );
  DCDL U2 ( .clk_mid(clk_mid), .T(T), .Tb(Tb), .T_f1(T_f1), .Tb_f1(Tb_f1), 
        .T_f2(T_f2), .Tb_f2(Tb_f2), .Sel(Sel), .clk_ext(clk_ext), 
        .clk_out_out(clk_out), .clk_out(n52) );
  Clock_counter U3 ( .clk_ext(clk_ext), .clk_out(clk_out), .N(N), .M({M[1], 
        n19}), .rst_n(n20), .N_counter(N_counter), .M_counter(M_counter) );
  INVX2 U23 ( .A(clk_out), .Y(n17) );
  MXI2X6 U26 ( .A(n18), .B(n44), .S0(Sel[0]), .Y(clk_mid) );
  NAND2BX1 U27 ( .AN(n46), .B(n45), .Y(clk_out) );
  CLKINVX2 U28 ( .A(glitch_free[29]), .Y(n24) );
  NOR4BX2 U29 ( .AN(n41), .B(glitch_free[32]), .C(n40), .D(glitch_free[31]), 
        .Y(n43) );
  INVX2 U30 ( .A(glitch_free[34]), .Y(n42) );
  CLKINVX2 U31 ( .A(n52), .Y(n47) );
  INVX2 U32 ( .A(n51), .Y(n45) );
  NOR2X2 U33 ( .A(n48), .B(n47), .Y(n53) );
  NAND2BX2 U34 ( .AN(n46), .B(n45), .Y(n49) );
  INVXL U35 ( .A(clk_ext), .Y(n44) );
  NAND3BX2 U36 ( .AN(glitch_free[33]), .B(n43), .C(n42), .Y(n46) );
  INVXL U37 ( .A(glitch_free[30]), .Y(n41) );
  NAND4BX2 U38 ( .AN(n39), .B(n38), .C(n37), .D(n36), .Y(n40) );
  NOR4BXL U39 ( .AN(n33), .B(glitch_free[4]), .C(n32), .D(glitch_free[3]), .Y(
        n37) );
  NOR4BXL U40 ( .AN(n35), .B(glitch_free[14]), .C(glitch_free[15]), .D(
        glitch_free[13]), .Y(n36) );
  NOR4BXL U41 ( .AN(n27), .B(glitch_free[21]), .C(glitch_free[22]), .D(
        glitch_free[20]), .Y(n38) );
  NAND4BXL U42 ( .AN(glitch_free[28]), .B(n25), .C(n24), .D(n23), .Y(n39) );
  INVXL U43 ( .A(glitch_free[27]), .Y(n25) );
  NOR4BXL U44 ( .AN(n22), .B(glitch_free[26]), .C(glitch_free[25]), .D(
        glitch_free[24]), .Y(n23) );
  INVXL U45 ( .A(glitch_free[23]), .Y(n22) );
  NOR4BXL U46 ( .AN(n26), .B(glitch_free[19]), .C(glitch_free[18]), .D(
        glitch_free[17]), .Y(n27) );
  INVXL U47 ( .A(glitch_free[16]), .Y(n26) );
  NOR4BXL U48 ( .AN(n34), .B(glitch_free[12]), .C(glitch_free[11]), .D(
        glitch_free[10]), .Y(n35) );
  INVXL U49 ( .A(glitch_free[9]), .Y(n34) );
  NOR4BXL U50 ( .AN(n28), .B(glitch_free[8]), .C(glitch_free[7]), .D(
        glitch_free[6]), .Y(n33) );
  INVXL U51 ( .A(glitch_free[5]), .Y(n28) );
  OAI31XL U52 ( .A0(n47), .A1(n48), .A2(n31), .B0(n30), .Y(n32) );
  INVXL U53 ( .A(glitch_free[1]), .Y(n31) );
  INVXL U54 ( .A(glitch_free[2]), .Y(n30) );
  CLKINVX4 U55 ( .A(n29), .Y(n48) );
  BUFX2 U56 ( .A(M[0]), .Y(n19) );
  INVX2 U57 ( .A(n21), .Y(n20) );
  INVX2 U58 ( .A(rst_n), .Y(n21) );
  AO21X4 U59 ( .A0(Sel[1]), .A1(Sel[0]), .B0(n15), .Y(n29) );
endmodule
